    ...
    <section className="section-spacing bg-background">
      <div className="container">
        ...
        <AnimateOnScroll delay={100}>
          <div className="max-w-2xl mx-auto bg-card border rounded-2xl md:rounded-3xl p-7 md:p-10 space-y-7 shadow-lg shadow-primary/3 hover:shadow-xl hover:shadow-primary/5 transition-shadow duration-500">
